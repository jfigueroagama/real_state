class Api::V1::RealStateEntitiesController < ApplicationController
  ...
  def create
    ...
    if @real_state_entity.save
      render json: @real_state_entity, status: :created, location: api_vi_real_state_path(@real_state_entity)
    else
  ...
  private
    ...
    def real_state_entity_params
      params.require(:real_state_entity).permit(:id, :name, :real_state_type, :street, :external_number, :internal_number, :neighborhood, :city, :country, :rooms, :bathrooms, :comments)
    end
end
